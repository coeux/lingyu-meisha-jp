S350_magic_H012_attack = 
{
	info_pool = {},

	init = function( effectScript )
		S350_magic_H012_attack.info_pool[effectScript.ID] = { Attacker = 0,Targeter = 0,  AttackType = 0, AttackDataList = {}, AttackIndex = 1 }
	end,

	clean = function( effectScript )
		EffectScriptEnd(S350_magic_H012_attack.info_pool[effectScript.ID].Attacker)
        
		S350_magic_H012_attack.info_pool[effectScript.ID] = nil
	end,
	...
	b = function( effectScript )
		SetAnimation(S350_magic_H012_attack.info_pool[effectScript.ID].Attacker, AnimationType.chant)
		PlaySound("stalk_01201")
	end,

	dfdg = function( effectScript )
		AttachAvatarPosEffect(false, S350_magic_H012_attack.info_pool[effectScript.ID].Attacker, AvatarPos.root, Vector2(0, 0), 1, 100, "H012_xuli")
	end,
	...
	a = function( effectScript )
		SetAnimation(S350_magic_H012_attack.info_pool[effectScript.ID].Attacker, AnimationType.skill)
	...
	ewfef = function( effectScript )
		AttachAvatarPosEffect(false, S350_magic_H012_attack.info_pool[effectScript.ID].Attacker, AvatarPos.root, Vector2(0, 0), 1, 100, "S350_1")
	end,
	...
	c = function( effectScript )
		AttachAvatarPosEffect(false, S350_magic_H012_attack.info_pool[effectScript.ID].Attacker, AvatarPos.root, Vector2(-100, 0), 1.3, 100, "S350_2")
	end,

	hgfhgjkhk = function( effectScript )
			DamageEffect(S350_magic_H012_attack.info_pool[effectScript.ID].Attacker, S350_magic_H012_attack.info_pool[effectScript.ID].Targeter, S350_magic_H012_attack.info_pool[effectScript.ID].AttackType, S350_magic_H012_attack.info_pool[effectScript.ID].AttackDataList, S350_magic_H012_attack.info_pool[effectScript.ID].AttackIndex, effectScript)
	end,
