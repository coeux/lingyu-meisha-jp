S401_magic_attack = 
{
	...
	init = function( effectScript )
		S401_magic_attack.info_pool[effectScript.ID] = { Attacker = 0,Targeter = 0,  AttackType = 0, AttackDataList = {}, AttackIndex = 1 }
	end,

	clean = function( effectScript )
		EffectScriptEnd(S401_magic_attack.info_pool[effectScript.ID].Attacker)
	...
	C = function( effectScript )
		...
		DamageEffect(S401_magic_attack.info_pool[effectScript.ID].Attacker, S401_magic_attack.info_pool[effectScript.ID].Targeter, S401_magic_attack.info_pool[effectScript.ID].AttackType, S401_magic_attack.info_pool[effectScript.ID].AttackDataList, S401_magic_attack.info_pool[effectScript.ID].AttackIndex, effectScript)
	CameraShake()
