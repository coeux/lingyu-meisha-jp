H012_auto92_attack = 
{
	...
	init = function( effectScript )
		H012_auto92_attack.info_pool[effectScript.ID] = { Attacker = 0,Targeter = 0,  AttackType = 0, AttackDataList = {}, AttackIndex = 1 }
	end,

	clean = function( effectScript )
		EffectScriptEnd(H012_auto92_attack.info_pool[effectScript.ID].Attacker)
        
		H012_auto92_attack.info_pool[effectScript.ID] = nil
	end,
	...
	sfdgfhj = function( effectScript )
		SetAnimation(H012_auto92_attack.info_pool[effectScript.ID].Attacker, AnimationType.skill)
	end,
	...
	sfdh = function( effectScript )
		AttachAvatarPosEffect(false, H012_auto92_attack.info_pool[effectScript.ID].Attacker, AvatarPos.root, Vector2(0, 0), 1, 100, "S350_1")
	end,
	...
	sdgdfh = function( effectScript )
		AttachAvatarPosEffect(false, H012_auto92_attack.info_pool[effectScript.ID].Attacker, AvatarPos.root, Vector2(0, 0), 1, 100, "S350_2")
	end,
	...
	fdgfhj = function( effectScript )
			DamageEffect(H012_auto92_attack.info_pool[effectScript.ID].Attacker, H012_auto92_attack.info_pool[effectScript.ID].Targeter, H012_auto92_attack.info_pool[effectScript.ID].AttackType, H012_auto92_attack.info_pool[effectScript.ID].AttackDataList, H012_auto92_attack.info_pool[effectScript.ID].AttackIndex, effectScript)
	end,
