S221_magic_attack = 
{
	...
	init = function( effectScript )
		S221_magic_attack.info_pool[effectScript.ID] = { Attacker = 0,Targeter = 0,  AttackType = 0, AttackDataList = {}, AttackIndex = 1 }
	end,

	clean = function( effectScript )
		EffectScriptEnd(S221_magic_attack.info_pool[effectScript.ID].Attacker)
	...
	jisuanshanghai = function( effectScript )
		CameraShake()
		DamageEffect(S221_magic_attack.info_pool[effectScript.ID].Attacker, S221_magic_attack.info_pool[effectScript.ID].Targeter, S221_magic_attack.info_pool[effectScript.ID].AttackType, S221_magic_attack.info_pool[effectScript.ID].AttackDataList, S221_magic_attack.info_pool[effectScript.ID].AttackIndex, effectScript)
	end,
