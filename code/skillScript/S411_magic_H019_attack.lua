S411_magic_H019_attack = 
{
	info_pool = {},

	init = function( effectScript )
		S411_magic_H019_attack.info_pool[effectScript.ID] = { Attacker = 0,Targeter = 0,  AttackType = 0, AttackDataList = {}, AttackIndex = 1 }
	end,

	clean = function( effectScript )
		EffectScriptEnd(S411_magic_H019_attack.info_pool[effectScript.ID].Attacker)
        
		S411_magic_H019_attack.info_pool[effectScript.ID] = nil
	end,
	...
	dsfdgh = function( effectScript )
		SetAnimation(S411_magic_H019_attack.info_pool[effectScript.ID].Attacker, AnimationType.skill2)
	end,
	...
	gfdhsgfjh = function( effectScript )
		AttachAvatarPosEffect(false, S411_magic_H019_attack.info_pool[effectScript.ID].Attacker, AvatarPos.root, Vector2(10, 0), 1, 100, "S412_1")
	end,
	...
	sfdggfh = function( effectScript )
		AttachAvatarPosEffect(false, S411_magic_H019_attack.info_pool[effectScript.ID].Targeter, AvatarPos.root, Vector2(0, 0), 1, 100, "S412_2")
	end,
	...
	fdgfh = function( effectScript )
			DamageEffect(S411_magic_H019_attack.info_pool[effectScript.ID].Attacker, S411_magic_H019_attack.info_pool[effectScript.ID].Targeter, S411_magic_H019_attack.info_pool[effectScript.ID].AttackType, S411_magic_H019_attack.info_pool[effectScript.ID].AttackDataList, S411_magic_H019_attack.info_pool[effectScript.ID].AttackIndex, effectScript)
	end,
