#ifndef _sc_platform_client_h_
#define _sc_platform_client_h_

#include "rpc_client.h"
#include "singleton.h"
#include "msg_def.h"

class sc_platform_client_t;
typedef boost::shared_ptr<sc_platform_client_t> sp_sc_platform_client_t;

class sc_platform_handler_t : public rpc_t
{
    typedef boost::shared_ptr<rpc_connecter_t>          sp_rpc_conn_t;
public:
    sc_platform_handler_t(io_t& io_);
    //网关断开
...
private:
    sp_sc_platform_client_t m_client;
};

class sc_platform_client_t : public rpc_client_t<sc_platform_handler_t>
{
    friend class sc_platform_handler_t;
    typedef boost::shared_ptr<boost::asio::deadline_timer>  sp_timer_t;
public:
    sc_platform_client_t(io_t& io_);
    ~sc_platform_client_t();
...
#define platform_client (singleton_t<sc_platform_client_t>::instance())
