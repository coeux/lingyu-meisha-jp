port_info=
{
route = {out=41105,inner=41205},
gw = {out=42105,inner=42205},
inv = {out=0,inner=43005},
}
...
sqldb_map['1'] = {
    ...
    pwd ='13683048948o',
    name='niceshot_base',
    --name='niceserver_online_2_ceshi',
}
...
gslist = 
{
    { hostnum = 1, name = 'PvP专用测试服', serid = 1, recom=true},
    { hostnum = 181, name = 'PvP专', serid = 181, recom=true},
    { hostnum = 165, name = 'PvP专用服', serid = 165, recom=true},
    --[[
    { hostnum = 2, name = '董行行专用1', serid = 2, recom=true},
    { hostnum = 3, name = '董行行专用2', serid = 3, recom=true},
    { hostnum = 4, name = '董行行专用3', serid = 4, recom=true},
    --]]
} 
