...
gateway_map = {}
gateway_map['1'] = {
    listen_ip= '202.133.247.199',
    public_ip = '202.133.247.199',
...
route = {}
route.listen_ip= '202.133.247.199'
route.public_ip = '202.133.247.199'
route.private_port = tostring(port_info.route.inner)
route.private_ip = '192.168.1.14'
