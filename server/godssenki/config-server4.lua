port_info=
{
route = {out=41104,inner=41204},
gw = {out=42104,inner=42204},
inv = {out=0,inner=43004},
}
...
gslist = 
{
   -- { hostnum = 101, name = '线上1服的数据库', serid = 101, recom=true},
    { hostnum = 1, name = '测试4服', serid = 1, recom=true},
    { hostnum = 91, name = '测试91服', serid = 91, recom=true},
} 
