...
#include "lua_table.h"
#include "detail/call_lua_detail.h"
#include "detail/class_register.h"

class ys_lua_t: private boost::noncopyable
{
...
public:
    ys_lua_t();
    ys_lua_t(lua_State* ls_, bool auto_release_ = false);
    ~ys_lua_t();
...
template<typename T>
void ys_lua_t::open_lib(T arg_)
{
    arg_(m_ls);
}

template<typename T>
int  ys_lua_t::get_global_field(const string& field_name_, T& ret_)
{
    return get_global_field<T>(field_name_.c_str(), ret_);
}

template<typename T>
int  ys_lua_t::get_global_field(const char* field_name_, T& ret_)
{
     int ret = 0;
...
template<typename T>
int  ys_lua_t::set_global_field(const string& field_name_, const T& value_)
{
    return set_global_field<T>(field_name_.c_str(), value_);
}

template<typename T>
int  ys_lua_t::set_global_field(const char* field_name_, const T& value_)
{
...
template<typename T>
void ys_lua_t::call(T func_)
{
    func_.call(m_ls);
}

template<typename RET>
RET ys_lua_t::call(const char* func_name_) throw (lua_exception_t)
{
    return call_lua_detail_t<RET>::call(m_ls, func_name_);
}

template<typename RET, typename ARG1>
RET ys_lua_t::call(const char* func_name_, const ARG1& arg1_) throw (lua_exception_t)
{
    return call_lua_detail_t<RET>::call(m_ls, func_name_, arg1_);
}

template<typename RET, typename ARG1, typename ARG2>
RET ys_lua_t::call(const char* func_name_, const ARG1& arg1_, const ARG2& arg2_) throw (lua_exception_t)
{
    return call_lua_detail_t<RET>::call(m_ls, func_name_, arg1_, arg2_);
}

template<typename RET, typename ARG1, typename ARG2, typename ARG3>
RET ys_lua_t::call(const char* func_name_, const ARG1& arg1_, const ARG2& arg2_,
                                  const ARG3& arg3_) throw (lua_exception_t)
{
...
template<typename RET, typename ARG1, typename ARG2, typename ARG3, typename ARG4>
RET ys_lua_t::call(const char* func_name_, const ARG1& arg1_, const ARG2& arg2_, const ARG3& arg3_,
                                  const ARG4& arg4_) throw (lua_exception_t)
{
...
template<typename FUNC>
void  ys_lua_t::register_static_function(const char* mod_name_, const char* func_name_, FUNC func_)
{
    char buff[1024];
...
template<typename FUNC>
void  ys_lua_t::register_global_function(const char* func_name_, FUNC func_)
{
    lua_checkstack(m_ls, STACK_CHECK_NUM);
...
template<typename CLASS_TYPE, typename FUNC_TYPE>
void  ys_lua_t::register_class_base(const string& class_name_)
{
    lua_checkstack(m_ls, STACK_CHECK_NUM);
...
template<typename CLASS_TYPE, typename FUNC_TYPE>
void  ys_lua_t::register_virtual_class_base(const string& class_name_)
{
    lua_checkstack(m_ls, STACK_CHECK_NUM);
...
template<typename CLASS_TYPE, typename FUNC_TYPE>
void  ys_lua_t::register_class_method(const string& class_name_, const string& func_name_, FUNC_TYPE func_)
{
    lua_checkstack(m_ls, STACK_CHECK_NUM);
...
template<typename CLASS_TYPE, typename PROPERTY_TYPE>
void  ys_lua_t::register_class_property(const string& property_name_, PROPERTY_TYPE p_)
{
    lua_checkstack(m_ls, STACK_CHECK_NUM);
...
template<typename T>
void  ys_lua_t::multi_register(T a)
{
    a(*this);
}
...
template<typename ARG1>
void ys_lua_t::call(const string& func_name_, const ARG1& arg1_) throw (lua_exception_t)
{
    call_lua_detail_t<void>::call(m_ls, func_name_.c_str(), arg1_);
}

template<typename ARG1, typename ARG2>
void ys_lua_t::call(const string& func_name_, const ARG1& arg1_, const ARG2& arg2_) throw (lua_exception_t)
{
    call_lua_detail_t<void>::call(m_ls, func_name_.c_str(), arg1_, arg2_);
}

template<typename ARG1, typename ARG2, typename ARG3>
void ys_lua_t::call(const string& func_name_, const ARG1& arg1_, const ARG2& arg2_,
                                   const ARG3& arg3_) throw (lua_exception_t)
{
...
template<typename ARG1, typename ARG2, typename ARG3, typename ARG4>
void ys_lua_t::call(const string& func_name_, const ARG1& arg1_, const ARG2& arg2_, const ARG3& arg3_,
                                   const ARG4& arg4_) throw (lua_exception_t)
{
